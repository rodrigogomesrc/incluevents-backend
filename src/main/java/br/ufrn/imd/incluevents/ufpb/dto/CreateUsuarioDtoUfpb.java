...
public record CreateUsuarioDtoUfpb(String nome, String email, String senha, String username, TipoUsuarioEnumUfpb tipo, CargoEnumUfpb cargo, Integer tempoServico) implements CreateUsuarioDto {
